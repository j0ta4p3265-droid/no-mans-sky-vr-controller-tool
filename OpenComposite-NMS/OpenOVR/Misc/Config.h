...
public:
	...
	float RightJoystickScale() const { return rightJoystickScale; }
	bool EnableThumbrestDoubleTap() const { return enableThumbrestDoubleTap; }
	bool EnableRightThumbrestDoubleTap() const { return enableRightThumbrestDoubleTap; }
	int ThumbrestDoubleTapWindowMs() const { return thumbrestDoubleTapWindowMs; }
...
private:
	...
	float rightJoystickScale = 1.0f;
	bool enableThumbrestDoubleTap = false;
	bool enableRightThumbrestDoubleTap = false;
	int thumbrestDoubleTapWindowMs = 450;
