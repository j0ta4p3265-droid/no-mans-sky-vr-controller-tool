...
private:
	...
	std::unique_ptr<NmsVulkanKeyboard> vulkanKeyboard;
...
public:
	...
	virtual vr::EVROverlayError CreateSubviewOverlay(vr::VROverlayHandle_t parentOverlayHandle, const char* pchSubviewOverlayKey, const char* pchSubviewOverlayName, vr::VROverlayHandle_t* pSubviewOverlayHandle);
