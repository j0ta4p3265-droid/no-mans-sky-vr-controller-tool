...
enum OOVR_EVRCompositorTextureUsage {
	VRCompositorTextureUsage_Left = vr::Eye_Left,
	VRCompositorTextureUsage_Right = vr::Eye_Right,
...
public:
	// Last Vulkan texture description submitted by the game.  Internal overlays
	// (notably the OpenVR keyboard) use the same device/queue as the game.
	static vr::VRVulkanTextureData_t lastVulkanTexture;
	static bool hasVulkanTexture;
...
public:
	...
	virtual ovr_enum_t GetSubmitTexture(vr::Texture_t* pOutTexture, bool* pNeedsFlush, OOVR_EVRCompositorTextureUsage eUsage,
	...
	virtual ovr_enum_t SubmitWithArrayIndex(vr::EVREye eEye, const vr::Texture_t* pTexture, uint32_t unTextureArrayIndex,
	    const vr::VRTextureBounds_t* pBounds, vr::EVRSubmitFlags nSubmitFlags = vr::Submit_Default);
