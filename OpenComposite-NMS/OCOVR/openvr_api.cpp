...
VR_INTERFACE bool VR_CALLTYPE VR_IsHmdPresent()
{
	...
	// VDXR currently exposes OpenXR 1.0.  The normal backend initialization is
	// already pinned to 1.0, but Game Pass probes VR_IsHmdPresent first and used
	// to request the SDK's newer current version here, failing with
	// XR_ERROR_API_VERSION_UNSUPPORTED (-4) before normal startup could begin.
