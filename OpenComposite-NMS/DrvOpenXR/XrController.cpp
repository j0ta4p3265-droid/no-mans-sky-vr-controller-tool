...
{
	if (type == XCT_LEFT)
		OOVR_LOG_ONCE("NMS hand route: tracked-device GetPose requested for LEFT controller");
	else if (type == XCT_RIGHT)
		OOVR_LOG_ONCE("NMS hand route: tracked-device GetPose requested for RIGHT controller");
